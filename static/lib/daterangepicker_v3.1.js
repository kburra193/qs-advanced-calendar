...
(function (root, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    define(["./moment.min", "jquery", "./encoder"], function (
      moment,
      jquery,
      encoder
    ) {
      ...
      return factory(moment, jquery, encoder);
    });
    ...
    var moment =
      typeof window != "undefined" && typeof window.moment != "undefined"
        ? window.moment
        : require("moment");
    module.exports = factory(moment, jQuery, encoder);
  } else {
    // Browser globals
    root.daterangepicker = factory(root.moment, root.jQuery, root.encoder);
  }
})(
  typeof window !== "undefined" ? window : this,
  function (moment, $, encoder) {
    ...
    DateRangePicker.prototype = {
      ...
      setEndDate: function (endDate) {
        ...
        if (!this.timePicker) this.endDate = this.endDate.endOf(this.viewMode);
      ...
      renderCalendar: function (side) {
        ...
        if (
          (!minDate || minDate.isBefore(aDayInTheDisplayedMonth, "month")) &&
        ...
        html +=
          '<th colspan="' +
          this.viewModes[this.viewMode].monthYearColSpan +
          '" class="month">' +
          dateHtml +
          "</th>";
        if (
          (!maxDate || maxDate.isAfter(aDayInTheDisplayedMonth, "month")) &&
            ...
            switch (this.viewMode) {
              case "month":
                if (calendar[row][col].isSame(new Date(), "month"))
                  classes.push("today");
                if (
                  calendar[row][col].format("YYYY-MM") ==
                  this.startDate.format("YYYY-MM")
                )
      ...
      showCalendars: function () {
        if (this.element.val() == "NaNlid date") this.element.val("20211016");
      ...
      updateElement: function () {
        if (this.element.is("input") && this.autoUpdateInput) {
          ...
          if (this.isTwYear) {
            ...
            ROCEraYear =
              ROCEraYear < 100 ? "0" + ROCEraYear : ROCEraYear.toString();
